# `createTestHarness()` example

This fixture shows how to use the `createTestHarness()` API as an integration-test harness for a multi-Worker app. It includes examples for both Wrangler and Vite projects.
...
- Starting Workers from Wrangler config files with `createTestHarness()`.
